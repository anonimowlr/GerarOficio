...
public class Oficio {
    ...
    private String gerenteSetor;
    private String tipoGer;
    ...
    public String getTipoGer() {
        return tipoGer;
    }

    public void setTipoGer(String tipoGer) {
        this.tipoGer = tipoGer;
    }

    public String getGerenteSetor() {
        return gerenteSetor;
    }

    public void setGerenteSetor(String gerenteSetor) {
        this.gerenteSetor = gerenteSetor;
    }
